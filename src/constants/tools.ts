...
export const TOOLS = [
  ...
  // Phase 6: Numbers, Math & Date
  { id: 'unix-time-now', icon: Terminal, category: 'dev' },
  { id: 'date-difference-calc', icon: FileText, category: 'data' },
  { id: 'cron-expression-builder', icon: Terminal, category: 'dev' },
  { id: 'number-base-converter', icon: Hash, category: 'data' },
  { id: 'percentage-calculator', icon: Calculator, category: 'data' },
  { id: 'aspect-ratio-calculator', icon: Layout, category: 'design' },
  { id: 'byte-size-converter', icon: Repeat, category: 'data' },
  { id: 'roman-numeral-converter', icon: Repeat, category: 'data' },
  { id: 'random-number-generator', icon: Hash, category: 'dev' },
  { id: 'fibonacci-generator', icon: Hash, category: 'data' },
  { id: 'prime-number-checker', icon: Hash, category: 'data' },
  { id: 'gcd-lcm-calculator', icon: Calculator, category: 'data' },
  { id: 'bmi-calculator', icon: Calculator, category: 'data' },
  { id: 'scientific-calculator', icon: Calculator, category: 'data' },
  { id: 'currency-converter', icon: Repeat, category: 'data' },
  { id: 'temperature-converter', icon: Repeat, category: 'data' },
  { id: 'timezone-converter', icon: Globe, category: 'data' },
  { id: 'age-calculator', icon: FileText, category: 'data' },
  { id: 'loan-emi-calculator', icon: Calculator, category: 'data' },
];
