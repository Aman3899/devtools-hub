...
import { TypographyScaleGeneratorClient } from './components/typography-scale-generator-client';
import { Card, CardHeader, CardTitle, CardContent } from '@/components/ui/card';

export async function generateMetadata({ params: { locale } }: { params: { locale: string } }) {
  const t = await getTranslations({ locale, namespace: 'tools.typography-scale-generator' });
  return {
    title: t('title'),
