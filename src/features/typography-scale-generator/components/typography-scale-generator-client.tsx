      ...
      <div className="grid gap-6 lg:grid-cols-12 items-start">
        <div className="lg:col-span-9 space-y-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Card className="border border-border shadow-none rounded-md overflow-hidden bg-background p-8 md:p-12 space-y-8">
               {scale.map((s, i) => (
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between px-1">
              ...
              <Button variant="ghost" size="sm" onClick={copyCode} className="h-6 px-2 text-[10px] gap-1.5 text-muted-foreground hover:text-foreground">
          ...
          <Card className="border border-border shadow-none rounded-md bg-background">
            <CardHeader className="py-3 px-4 border-b">
              <CardTitle className="text-xs font-semibold flex items-center justify-between">
                ...
                <RefreshCw className="h-3 w-3 text-muted-foreground hover:text-foreground cursor-pointer" onClick={() => { setBaseSize(16); setRatio(1.25); }} />
              </CardTitle>
            </CardHeader>
