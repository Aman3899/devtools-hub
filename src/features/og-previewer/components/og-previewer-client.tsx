...
import { Trash2, Settings2, Info, Share2, Globe, Image as ImageIcon } from 'lucide-react';
      ...
      <div className="md:col-span-2 grid gap-4 sm:grid-cols-2">
        ...
        >
          <Textarea 
            ...
            className="h-64 text-xs font-mono resize-none border border-border"
          />
        </ToolCard>

        {/* Preview Area */}
        <ToolCard title={commonT('ui.result')} contentClassName="p-4 space-y-4">
