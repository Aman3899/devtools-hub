...
import { NeumorphismGeneratorClient } from './components/neumorphism-generator-client';
import { Card, CardHeader, CardTitle, CardContent } from '@/components/ui/card';

export async function generateMetadata({ params: { locale } }: { params: { locale: string } }) {
  const t = await getTranslations({ locale, namespace: 'tools.neumorphism-generator' });
  return {
    title: t('title'),
